...
<div class="min-h-screen">
    <div class="p-5 sm:p-7.5 lg:p-9">
        ...
        <div class="max-w-2xl rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-dark-800 sm:p-8">
            ...
            <form method="POST" action="<?php echo e(route('assets.update', $asset)); ?>" class="space-y-6" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="photo_serial_url" type="url" name="photo_serial_url" value="<?php echo e($photoSerialUrlValue); ?>" placeholder="https://drive.google.com/..." class="w-full mt-2 rounded-lg border border-gray-300 px-3 py-2" />
                        <?php $__errorArgs = ['photo_serial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        <?php $__errorArgs = ['photo_serial_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        <?php if($asset->photo_serial): ?>
                            <div class="mt-3">
                                ...
                                <?php if(str_starts_with($asset->photo_serial, 'drive:')): ?>
                                    <iframe src="<?php echo e(\App\Models\Asset::googleDrivePreviewUrl(substr($asset->photo_serial, 6))); ?>" class="mt-2 h-40 w-full rounded-lg border" frameborder="0" allowfullscreen></iframe>
                                <?php elseif(preg_match('/^https?:\/\//', $asset->photo_serial)): ?>
                                    <img src="<?php echo e($asset->photo_serial); ?>" class="mt-2 max-h-40 rounded-lg border" alt="Foto Serial" />
                                <?php else: ?>
                                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($asset->photo_serial)); ?>" class="mt-2 max-h-40 rounded-lg border" alt="Foto Serial" />
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Atau masukkan link drive pada kolom berikut.</p>
                        <input id="photo_asset_url" type="url" name="photo_asset_url" value="<?php echo e($photoAssetUrlValue); ?>" placeholder="https://drive.google.com/..." class="w-full mt-2 rounded-lg border border-gray-300 px-3 py-2" />
                        <?php $__errorArgs = ['photo_asset'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        <?php $__errorArgs = ['photo_asset_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <?php if($asset->photo_asset): ?>
                            <div class="mt-3">
                                ...
                                <?php if(str_starts_with($asset->photo_asset, 'drive:')): ?>
                                    <iframe src="<?php echo e(\App\Models\Asset::googleDrivePreviewUrl(substr($asset->photo_asset, 6))); ?>" class="mt-2 h-40 w-full rounded-lg border" frameborder="0" allowfullscreen></iframe>
                                <?php elseif(preg_match('/^https?:\/\//', $asset->photo_asset)): ?>
                                    <img src="<?php echo e($asset->photo_asset); ?>" class="mt-2 max-h-40 rounded-lg border" alt="Foto Aset" />
                                <?php else: ?>
                                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($asset->photo_asset)); ?>" class="mt-2 max-h-40 rounded-lg border" alt="Foto Aset" />
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="nilai_perolehan" type="number" step="0.01" name="nilai_perolehan" value="<?php echo e(old('nilai_perolehan', $asset->nilai_perolehan)); ?>" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 placeholder-gray-500 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-100 disabled:cursor-default disabled:bg-gray-50 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-brand-600 dark:focus:ring-brand-900/20 <?php $__errorArgs = ['nilai_perolehan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="kode_satker" type="text" name="kode_satker" value="<?php echo e(old('kode_satker', $asset->kode_satker)); ?>" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 placeholder-gray-500 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-100 disabled:cursor-default disabled:bg-gray-50 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-brand-600 dark:focus:ring-brand-900/20 <?php $__errorArgs = ['kode_satker'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="nip_pegawai" type="text" name="nip_pegawai" value="<?php echo e(old('nip_pegawai', $asset->nip_pegawai)); ?>" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 placeholder-gray-500 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-100 disabled:cursor-default disabled:bg-gray-50 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-brand-600 dark:focus:ring-brand-900/20 <?php $__errorArgs = ['nip_pegawai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__currentLoopData = \App\Models\Asset::statusOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>" <?php echo e(old('status', $asset->status) === $value ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
