...
<div class="min-h-screen">
    <div class="p-5 sm:p-7.5 lg:p-9">
        ...
        <div class="max-w-2xl rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-dark-800 sm:p-8">
            ...
            <form method="POST" action="<?php echo e(route('assets.store')); ?>" class="space-y-6" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="photo_serial_url" type="url" name="photo_serial_url" value="<?php echo e(old('photo_serial_url')); ?>" placeholder="https://drive.google.com/..." class="w-full mt-2 rounded-lg border border-gray-300 px-3 py-2" />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Atau masukkan link drive pada kolom berikut.</p>
                        <input id="photo_asset_url" type="url" name="photo_asset_url" value="<?php echo e(old('photo_asset_url')); ?>" placeholder="https://drive.google.com/..." class="w-full mt-2 rounded-lg border border-gray-300 px-3 py-2" />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="nilai_perolehan" type="number" step="0.01" name="nilai_perolehan" value="<?php echo e(old('nilai_perolehan')); ?>" placeholder="e.g., 30500000" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 placeholder-gray-500 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-100 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-brand-600 dark:focus:ring-brand-900/20 <?php $__errorArgs = ['nilai_perolehan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="nip_pegawai" type="text" name="nip_pegawai" value="<?php echo e(old('nip_pegawai')); ?>" placeholder="e.g., 197905132009022006" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 placeholder-gray-500 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-100 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-brand-600 dark:focus:ring-brand-900/20 <?php $__errorArgs = ['nip_pegawai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
