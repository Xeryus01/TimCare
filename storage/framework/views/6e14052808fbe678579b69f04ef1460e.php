    ...
    <div class="p-5 sm:p-7.5 lg:p-9">
        <div class="mb-6 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <?php if(auth()->user()->hasRole('Admin') || (! in_array($reservation->status, [\App\Models\Reservation::STATUS_CANCELLED]) && (auth()->user()->hasAnyRole(['Teknisi']) || auth()->id() === $reservation->requester_id))): ?>
