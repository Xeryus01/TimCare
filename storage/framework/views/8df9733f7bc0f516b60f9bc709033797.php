    ...
    <div class="p-5 sm:p-7.5 lg:p-9">
        ...
        <form method="GET" class="mb-4 flex flex-wrap gap-3 rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-dark-800">
            ...
            <select name="assignee_id" class="rounded-lg border-gray-300 px-3 py-2 dark:bg-dark-800 dark:text-white">
                ...
                <?php $__currentLoopData = $assignees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($a->id); ?>" <?php echo e((string) request('assignee_id') === (string) $a->id ? 'selected' : ''); ?>><?php echo e($a->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
<?php endif; ?>
<?php /**PATH D:\projects\timcare - Copy\resources\views/tickets/index.blade.php ENDPATH**/ ?>